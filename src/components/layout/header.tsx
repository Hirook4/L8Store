        ...
        <header className="bg-white border-b border-gray-300">
            ...
            <div className="w-full max-w-6xl mx-auto p-6">
                <div className="flex items-center">
                    <div className="w-32">
                        <Link href={"/"}>
                            <Image src="/assets/ui/logo-black.png" alt="L8Store" width={120} height={40} />
                        </Link>
                    </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className="md:hidden" onClick={() => setMenuOpened(!menuOpened)}>
                            <HeaderIcon src="/assets/ui/menu-black.png" alt="Menu" selected={menuOpened} srcSelected="/assets/ui/menu-white.png" />
                        </div>
                    </div>
                </div>
            </div>
